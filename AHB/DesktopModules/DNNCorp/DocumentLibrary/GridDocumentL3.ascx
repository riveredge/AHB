                                        ...
                                        <tr>
                                            <td valign="top" nowrap="nowrap">
                                                <table cellpadding="0" cellspacing="0" border="0" width="60">
                                                    <tr>
                                                        <td style='background-image: url(<%# ResolveUrl("images/Media.png")%>); background-repeat: no-repeat;
                                                            background-position: top left; width: 60px; height: 60px; padding-top: 20px;
                                                            padding-left: 22px;' valign="top" align="left">
