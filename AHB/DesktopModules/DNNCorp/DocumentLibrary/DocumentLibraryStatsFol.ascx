<%@ Control Language="c#" AutoEventWireup="True" CodeBehind="DocumentLibraryStatsFol.ascx.cs" Inherits="DotNetNuke.Professional.DocumentLibrary.DocumentLibraryStatsFol" %>
                ...
                <tr>
                    <td>
                        <table class="ToolbarBackgroundTop" cellspacing="0">
                            <tr>
                                <td class="ToolbarLeft">&nbsp;</td>
                                <td width="100%">&nbsp;<asp:Label ID="lblFolderViews" resourcekey="lblFolderViews" runat="server" Text="View Details"></asp:Label></td>
                                <td class="ToolbarRight">&nbsp;</td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table cellspacing="1" cellpadding="1" width="100%" border="0">
                            ...
                            <tr>
                                <td class="dgRowH" valign="top" nowrap="nowrap" width="150">
                                    <asp:Label ID="lblDetFolderViews" runat="server" CssClass="SubHead" resourcekey="lblDetFolderViews"></asp:Label>
                                </td>
                                <td>
                                            ...
                                            <table cellpadding="2" cellspacing="1" width="100%">
                                                <tr>
                                                    ...
                                                    <td class="dgRowH" width="100%">
                                                        <asp:Label CssClass="SubHead" ID="lblDetFolderStatsTimestamp" resourcekey="lblFolderStatsTimestamp" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="normal">
                                                        <%# DataBinder.Eval(Container.DataItem, "FolderStatsTimestamp") %>
                                                    </span>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                    ...
                    <td align="center">
                        ...
                        <asp:DataGrid ID="dgDocument" runat="server" CssClass="dgTbl" CellPadding="2" AllowCustomPaging="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn HeaderText="FolderViewCount" DataField="FolderViewCount" SortExpression="FolderViewCount">
                                    <HeaderStyle CssClass="dgTxtB" Wrap="false"></HeaderStyle>
