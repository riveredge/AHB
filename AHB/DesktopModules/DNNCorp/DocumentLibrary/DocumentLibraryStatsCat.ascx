<%@ Control Language="c#" AutoEventWireup="True" CodeBehind="DocumentLibraryStatsCat.ascx.cs" Inherits="DotNetNuke.Professional.DocumentLibrary.DocumentLibraryStatsCat" %>
                    ...
                    <td>
                        <table class="ToolbarBackgroundTop" cellspacing="0">
                            <tr>
                                <td class="ToolbarLeft">&nbsp;</td>
                                <td width="100%">
                                    &nbsp;<asp:Label ID="lblCategoryViews" resourcekey="lblCategoryViews" runat="server" Text="View Details"></asp:Label>
                                </td>
                                <td class="ToolbarRight">&nbsp;</td>
                            </tr>
                        </table>
                        ...
                        <table cellspacing="1" cellpadding="1" width="100%" border="0">
                            <tr>
                                <td class="dgRowH" nowrap="nowrap" width="150">
                                    <asp:Label ID="lblDetCategoryHierarchy" runat="server" CssClass="SubHead" resourcekey="lblDetCategoryHierarchy"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="lblDetCategoryHierarchyValue" runat="server" CssClass="Normal"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="dgRowH" valign="top" nowrap="nowrap" width="150">
                                    <asp:Label ID="lblDetCategoryViews" runat="server" CssClass="SubHead" resourcekey="lblDetCategoryViews"></asp:Label>
                                </td>
                                <td>
                                        ...
                                        <HeaderTemplate>
                                            <table cellpadding="2" cellspacing="1" width="100%">
                                                <tr>
                                                    ...
                                                    <td class="dgRowH" nowrap="nowrap">
                                                        <asp:Label CssClass="SubHead" ID="lblDetDNNUserName" resourcekey="lblDetDNNUserName" runat="server"></asp:Label>
                                                    </td>
                                                    <td class="dgRowH" width="100%">
                                                        <asp:Label CssClass="SubHead" ID="lblDetCategoryStatsTimestamp" resourcekey="lblCategoryStatsTimestamp" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="normal">
                                                        <%# DataBinder.Eval(Container.DataItem, "CategoryStatsTimestamp") %>
                                                    </span>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                ...
                <tr>
                    <td align="center">
                        <asp:Label ID="lblDocument" CssClass="normal" runat="server"></asp:Label><asp:DataGrid
                            ...
                            <Columns>
                                <asp:BoundColumn HeaderText="CategoryHierarchy" DataField="CategoryHierarchy" SortExpression="CategoryHierarchy">
                                    <HeaderStyle CssClass="dgTxtB" Wrap="false"></HeaderStyle>
                                    <ItemStyle CssClass="dgTxt" Wrap="false"></ItemStyle>
                                </asp:BoundColumn>
                                <asp:BoundColumn HeaderText="CategoryViewCount" DataField="CategoryViewCount" SortExpression="CategoryViewCount">
                                    <HeaderStyle CssClass="dgTxtB" Wrap="false"></HeaderStyle>
