    ...
    <anthem:Panel ID="pnlDL" runat="server">
        <table class="OuterTable" cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                <td>
                    <div align="center">
                        <asp:Label ID="lblDocumentGrid" runat="server" EnableViewState="false" CssClass="normal"></asp:Label></div>
                        ...
                        <Columns>
                                    ...
                                    <table cellspacing="0" cellpadding="0" width="100%" class="dgTblInt" border="0">
                                        <tr>
                                            <td valign="top" width="100%">
                                                <asp:Image ImageUrl='<%# SetIconUrl(DataBinder.Eval(Container.DataItem, "DocumentName"))%>' runat="server" ID="DocumentIcon" ImageAlign="AbsBottom"></asp:Image>
                                            ...
                                            <td valign="top">
                                                <table cellspacing="0" cellpadding="0" width="1" class="dgTxt" border="0">
                                                    ...
                                                    <tr class="dgTxtS" runat="server" id="Uploaded">
                                                        ...
                                                        <td valign="top" nowrap="nowrap" width="110px">
                                                    ...
                                                    <tr class="dgTxtS" runat="server" id="Modified">
                                                        ...
                                                        <td nowrap="nowrap" valign="top" width="110px">
                            ...
                            <asp:TemplateColumn HeaderText="Download">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:HyperLink ID="lnkPlay" runat="server" EnableViewState="false"></asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
