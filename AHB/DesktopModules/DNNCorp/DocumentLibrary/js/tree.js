...
function StdIco(path) {
  this.pnb = path+"plusnb.png";
  this.pb  = path+"plusb.png";
  this.mnb = path+"minusnb.png";
  this.mb  = path+"minusb.png";
  this.opf = path+"folderopen.png";
  this.clf = path+"folder.png";
  this.chd = path+"leaf.png";
  this.rot = path+"root.png";
  this.lnb = path+"lineang.png";
  this.lb  = path+"lineints.png";
  this.lin = path+"line.png";
  this.bln = path+"blank.png";
